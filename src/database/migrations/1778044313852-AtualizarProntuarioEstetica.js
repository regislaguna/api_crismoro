...
module .exports = class AtualizarProntuarioEstetica1778044313852  {
    

async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`prontuarios\` ADD \`comorbidades\` varchar(255) NULL COMMENT 'Alergias, diabetes, hipertensão, etc.'`);
        await queryRunner.query(`ALTER TABLE \`prontuarios\` ADD \`situacao_pele_corpo\` varchar(255) NULL COMMENT 'Fototipo, oleosidade, grau de celulite, etc.'`);
        await queryRunner.query(`ALTER TABLE \`prontuarios\` ADD \`ultimo_tratamento\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`prontuarios\` ADD \`tempo_tratamento\` varchar(255) NULL COMMENT 'Duração do tratamento ou número de sessões'`);
        await queryRunner.query(`ALTER TABLE \`prontuarios\` ADD \`produtos_maquinas\` text NULL COMMENT 'Guardado como JSON ou String com as máquinas/produtos usados'`);
     ...
     async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`prontuarios\` DROP COLUMN \`produtos_maquinas\``);
        ...
        await queryRunner.query(`ALTER TABLE \`prontuarios\` DROP COLUMN \`situacao_pele_corpo\``);
        await queryRunner.query(`ALTER TABLE \`prontuarios\` DROP COLUMN \`comorbidades\``);
    }
